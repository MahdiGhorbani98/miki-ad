...
const CardCampaign = ({ title, description }) => {
  return (
    <div className="w-72 shadow-my-shadow rounded-xl p-14 flex flex-col justify-center items-center cursor-pointer hover:bg-primary hover:text-white ease-out	duration-200">
